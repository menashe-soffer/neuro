...
if __name__ == '__main__':
    ...
    list_1, list_2 = data_availability_obj.get_suitable_epoch_files_and_contacts(min_timegap_hrs=MIN_TGAP, max_timegap_hrs=MAX_TGAP,
                                                                                           proc_type='gamma_c_60_160', event_list=[event_type], 
    ...
    (list_1, list_2, list_1R, list_2R) = data_availability_obj.intersect_epoch_files_and_contact_lists([list_1, list_2, list_1R, list_2R])
    
    contact_info = data_availability_obj.get_contact_info(list_1)
    
    tscale, data_1 = read_epoch_files_by_list(list_1, first_epoch=0, last_epoch=16, v_samp_per_sec=2, )
    tscale, data_2 = read_epoch_files_by_list(list_2, first_epoch=0, last_epoch=16, v_samp_per_sec=2)
